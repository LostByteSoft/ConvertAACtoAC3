...
## Software name, what is this, version, informations.
	echo "Software name: Convert XXX to x264-8b-30f.aac-2.0-44100hz-160k.sh"
	echo
	echo What it does ?
	echo "Convert ONE video file to x264-8b-30f.aac-2.0-44100hz-160k.mkv"
...
ffmpeg -i "$file" -vf format=yuv420p -c:v libx264 -crf 20 -r:v 30 -c:a aac -ar 44100 -ac 2 -b:a 160k "$name"-x264-8b-30f.aac-2.0-44100hz-160k.mkv
