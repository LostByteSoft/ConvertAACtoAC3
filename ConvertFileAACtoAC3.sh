...
# store it to $FILE
FILE=$(dialog --title "convert a file" --stdout --title "Please choose a file to convert(Select space bar)" --fselect /home/master/Desktop/ 14 48)

# convert file
#[ ! -z $FILE ] && convert_file "$FILE"

# The video was copied the audio was converted.

ffmpeg -i "$FILE" -c:s copy -c:v copy -c:a ac3 /home/master/Desktop/Output.ac3.mkv
