...
#!/usr/bin/ffmpeg
## -----===== Start of bash =====-----
	#printf '\033[8;40;85t'		# will resize the window, if needed.
	#printf '\033[8;50;100t'	# will resize the window, if needed.
	printf '\033[8;50;115t'	# will resize the window, if needed.
	#printf '\033[8;85;115t'	# will resize the window, if needed.
	sleep 0.50
...
echo -------------------------========================-------------------------
	...
	echo 2022-11-20_Sunday_05:11:36
	echo
