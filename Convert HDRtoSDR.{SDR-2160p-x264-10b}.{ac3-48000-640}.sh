...
## Software name, what is this, version, informations.
	...
	echo "Software name here"
echo -------------------------========================-------------------------

	echo What it does ?
	echo "Convert HDRtoSDR.{SDR-2160p-x264-10b}.{ac3-48000-640}"
echo -------------------------========================-------------------------
...
ffmpeg -i "$FILE" -vf zscale=t=linear:npl=100,format=gbrpf32le,zscale=p=bt709,tonemap=tonemap=hable:desat=0,zscale=t=bt709:m=bt709:r=tv,scale=3840:2160,format=yuv420p10le -c:v libx264 -crf 20 -r:v 30 -preset faster -tune fastdecode -c:a ac3 -ar 48000 -b:a 640k "$NAME".{SDR-2160p-x264-10b}.{ac3-48000-640}.mkv
