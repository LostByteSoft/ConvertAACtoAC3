...
ffmpeg -i "$file" -vf scale=1280x720:flags=lanczos,format=yuv420p -c:v libx264 -crf 20 -c:a aac -ar 44100 -ac 2 -b:a 160k "$name".720p-x264-8b.aac-2.0-44100hz-160k.mkv
