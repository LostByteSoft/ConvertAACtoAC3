...
ffmpeg -loglevel error -v error -stats -i -i "$file" -vf scale=3840x2160:flags=lanczos,format=yuv420p10le -c:v libx264 -qp 22 -strict experimental -c:a dts "$name".{2160p-x264-10b}.{dts}.mkv
