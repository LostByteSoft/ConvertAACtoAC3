...
parallel -a "/dev/shm/find.txt" -j $entry ffmpeg -i {} -vf scale=1280x720:flags=lanczos,format=yuv420p -c:v libx264 -crf 22 -preset faster -tune fastdecode -c:a aac -ac 2 -b:a 320k {.}.{720p-sdr-x264-10b}.{aac-2.0-320k}.mkv
