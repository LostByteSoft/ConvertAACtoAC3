...
parallel -a "/dev/shm/find.txt" -j $entry ffmpeg -i {} -vf scale=1920x1080:flags=lanczos,format=yuv420p -r:v 30 -c:v libx264 -crf 22 -preset faster -tune fastdecode -c:a aac -ac 2 -b:a 320k {.}.{1080p-sdr-x264-10b-30f}.{aac-2.0-320k}.mkv
