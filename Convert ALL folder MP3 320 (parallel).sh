...
## The code program.
	part=$((part+1))
	echo "-------------------------===== Section $part =====-------------------------"
	parallel -j $entry ffmpeg -i {} -acodec libmp3lame -b:a 320k {.}.mp3-320k.mp3 ::: "$file"/*.mp3
	parallel -j $entry ffmpeg -i {} -acodec libmp3lame -b:a 320k {.}.mp3-320k.mp3 ::: "$file"/*.aiff
	parallel -j $entry ffmpeg -i {} -acodec libmp3lame -b:a 320k {.}.mp3-320k.mp3 ::: "$file"/*.aac
	parallel -j $entry ffmpeg -i {} -acodec libmp3lame -b:a 320k {.}.mp3-320k.mp3 ::: "$file"/*.flac
	parallel -j $entry ffmpeg -i {} -acodec libmp3lame -b:a 320k {.}.mp3-320k.mp3 ::: "$file"/*.wav
