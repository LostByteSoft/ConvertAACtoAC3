...
## Software lead-in
	...
	echo 2022-02-03_Thursday_04:46:49
echo -------------------------========================-------------------------
...
entry=$(zenity --scale --value="$cpu" --value="$def" --min-value="0" --max-value="$cpu" --title "Convert files with Multi Cores Cpu" --text "How many cores do you want to use ? You have $cpu cores !\n\nDefault value is $def, it is suggested you only use real cores.\n\n(1 to whatever core you want to use)")
