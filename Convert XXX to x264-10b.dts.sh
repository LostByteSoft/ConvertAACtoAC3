...
## The code program.
	...
	ffmpeg -i "$file" -vf format=yuv420p10le -c:v libx264 -crf 20 -preset faster -tune fastdecode -strict experimental -c:a dts -ar 48000 -b:a 768k "$name".{"$res"p}.{SDR-x264-10b}.{dts-5.1}.mkv
