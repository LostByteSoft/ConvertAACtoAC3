...
echo You must put this file in the same directory of the file you want to convert !
echo Be careful it will convert ALL audio file in THIS directory.
