...
ffmpeg -loglevel error -v error -stats -i "$file" -vf scale=1920x1080:flags=lanczos,format=yuv420p10le -c:v libx264 -qp 22 -r:v 30 -strict -2 -c:a dts "$name".{1080p-x264-10b-30f}.{dts}.mkv
