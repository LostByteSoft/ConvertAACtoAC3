...
ffmpeg -loglevel error -v error -stats -i "$file" -vf scale=1280x720:flags=lanczos,format=yuv420p10le -c:v libx264 -qp 22 -strict experimental -c:a dts "$name".{720p-x264-10b}.{dts}.mkv
