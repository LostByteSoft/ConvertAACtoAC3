...
## Software name, what is this, version, informations.
	echo "Software name: Convert XXX to x264-8b.aac-2.0-44khz-192k.sh"
	echo
	echo What it does ?
	echo "Convert ONE video file to x264-8b.aac-2.0-44khz-192k.mkv"
...
ffmpeg -i "$file" -vf format=yuv420p -c:v libx264 -crf 20 -c:a aac -ar 44100 -ac 2 -b:a 192k "$name"-x264-8b.aac-2.0-44khz-192k.mkv
