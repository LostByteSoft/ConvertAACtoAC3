...
echo "Software lead out."
	echo
	echo "Debug data : debug=$debug error=$error part=$part noquit=$noquit random=$random random2=$random2 wol=$wol primeerror=$primeerror"
	echo
	echo "Debug active : activemaster=$activemaster activeserver=$activeserver activeacer=$activeacer activelenovo=$activelenovo activestargate=$activestargate"
	echo
