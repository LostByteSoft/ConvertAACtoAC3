...
# store it to $FILE
FILE=$(dialog --title "convert a file" --stdout --title "Please choose a file to convert(Select spacebar)" --fselect /home/master/Desktop/ 14 48)
