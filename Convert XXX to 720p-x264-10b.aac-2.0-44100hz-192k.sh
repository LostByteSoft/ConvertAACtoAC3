...
ffmpeg -i "$file" -vf scale=1280x720:flags=lanczos,format=yuv420p10le -c:v libx264 -crf 20 -c:a aac -ar 44100 -ac 2 -b:a 192k "$name".720p-x264-10b.aac-2.0-44100hz-192k.mkv
