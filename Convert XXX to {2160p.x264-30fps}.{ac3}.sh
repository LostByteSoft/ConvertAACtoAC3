...
echo "Output file : "$NAME".{2160p-x264-30fps}.{ac3}.mkv"
...
ffmpeg -i "$FILE" -vf scale=3840x2160:flags=lanczos -c:v libx264 -crf 20 -r:v 30 -c:a ac3 "$NAME".{2160p-x264-30fps}.{ac3}.mkv
